...
export default function Footer() {
  return (
    <footer className="bg-black text-white py-8">
      <div className="w-screen relative left-1/2 -translate-x-1/2 mb-7" style={{ height: "1px", backgroundColor: "#D0D5DD", transform: "scaleY(0.2)", transformOrigin: "top",}}></div>
      
      <div className="md:hidden px-6 flex flex-col items-start gap-6 w-full">
      ...
      <div className="hidden px-6 md:flex md:justify-between gap-5 md:items-start">
      ...
      <div className="hidden px-6 md:flex md:justify-end md:items-end md:mt-8">
